...
Each branch has a different fix. Without the transcript you're guessing. <your-personal-ai-project>: 3 real bugs found in 30 turns by reading the chat log table — none visible in code. (<your-bot>/feedback_chat_log_review_finds_real_bugs.md, workspace/feedback_read_actual_conversations_to_debug.md)
...
Fixing the persona prose is the LAST move. Check 1-3 first. (<your-bot>/feedback_treat_root_cause_not_symptom.md, workspace/feedback_capability_awareness_in_persona.md)
...
- Project memory: <your-agent-project> `feedback_executor_audit_trail_floor.md`, <your-bot> `feedback_treat_root_cause_not_symptom.md`
