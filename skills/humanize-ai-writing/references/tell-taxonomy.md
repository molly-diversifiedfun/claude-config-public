...
### 1B. Data: Repeated "Random" Numbers

**Detection rule:** Flag when:
- The number 47 appears as a "specific-seeming" quantity (AI's most common fabricated number)
- The same "random" number appears in multiple pieces within a batch
- Numbers cluster around AI favorites: 47, 73, 37, 42 (especially in social content)

**Fix strategy:** Replace with genuinely varied numbers. Each piece in a batch should use different numbers. Prefer numbers that feel lived-in: 14, 19, 23, 28, 31, 33, 38.

**Genre thresholds:**
| Genre | Threshold | Notes |
|-------|-----------|-------|
| Social media | Flag any 47 | Highest sensitivity — audience clocks AI instantly |
| Blog | Flag if 47 appears 2+ times | Single use may be coincidence |
| Business | Flag if repeated across docs | Pattern matters more than single instance |

**Also flag:** Identical "random" details repeated across a content batch (same tool name in every joke, same time reference, same scenario framing).

### 1B2. Structural: Summary Paragraphs
